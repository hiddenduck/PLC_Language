...
_lr_productions = [
  ...
  ('Block -> Exp ;','Block',2,'p_block_exp','yacc.py',54),
  ('Block -> If','Block',1,'p_block_if','yacc.py',59),
  ('Block -> IfElse','Block',1,'p_block_ifelse','yacc.py',64),
  ('Block -> While','Block',1,'p_block_while','yacc.py',69),
  ('Block -> Switch','Block',1,'p_block_switch','yacc.py',74),
  ('Body -> { }','Body',2,'p_body_empty','yacc.py',83),
  ('Body -> Block','Body',1,'p_body_block','yacc.py',88),
  ('Body -> { Code }','Body',3,'p_body_code','yacc.py',93),
  ('Function -> ID FunScope FunCases Body','Function',4,'p_function','yacc.py',98),
  ('FunScope -> :','FunScope',1,'p_funscope','yacc.py',127),
  ('FunCases -> FunExtra RARROW ID','FunCases',3,'p_funcases_funextra_rarrow','yacc.py',133),
  ('FunCases -> RARROW ID','FunCases',2,'p_funcases_rarrow','yacc.py',153),
  ('FunCases -> FunExtra','FunCases',1,'p_funcases_funextra','yacc.py',163),
  ('FunCases -> <empty>','FunCases',0,'p_funcases_empty','yacc.py',177),
  ('FunExtra -> FunExtra , ID','FunExtra',3,'p_funextra_rec','yacc.py',182),
  ('FunExtra -> ID','FunExtra',1,'p_funextra_empty','yacc.py',188),
  ('IfScope -> IF','IfScope',1,'p_if_scope','yacc.py',193),
  ('If -> IfScope AtribOp Body','If',3,'p_if','yacc.py',199),
  ('ElseScope -> ELSE','ElseScope',1,'p_else_scope','yacc.py',211),
  ('IfElse -> IfScope AtribOp Body ElseScope Body','IfElse',5,'p_ifelse','yacc.py',219),
  ('WhileScope -> WHILE','WhileScope',1,'p_while_scope','yacc.py',234),
  ('While -> WhileScope ( AtribOp ) Body','While',5,'p_while','yacc.py',240),
  ('SwitchScope -> SWITCH','SwitchScope',1,'p_switch_scope','yacc.py',255),
  ('Switch -> SwitchScope Conds { Cases }','Switch',5,'p_switch','yacc.py',267),
  ('Conds -> Conds , Cond','Conds',3,'p_conds_rec','yacc.py',307),
  ('Conds -> Cond','Conds',1,'p_conds_base','yacc.py',313),
  ('Cond -> ID ( AtribOp )','Cond',4,'p_cond_id','yacc.py',318),
  ('Cond -> ( AtribOp )','Cond',3,'p_cond_empty','yacc.py',324),
  ('Cases -> Cases Case','Cases',2,'p_cases_rec','yacc.py',330),
  ('Cases -> Case','Cases',1,'p_cases_base','yacc.py',336),
  ('Case -> ID : Body','Case',3,'p_case_id','yacc.py',341),
  ('Case -> : Body','Case',2,'p_case_empty','yacc.py',348),
  ('Exp -> Atrib','Exp',1,'p_exp_atrib','yacc.py',362),
  ('Exp -> Op','Exp',1,'p_exp_op','yacc.py',367),
  ('Exp -> Decl','Exp',1,'p_exp_decl','yacc.py',372),
  ('Exp -> DeclArray','Exp',1,'p_exp_declarray','yacc.py',377),
  ('Exp -> DeclAtrib','Exp',1,'p_exp_declatrib','yacc.py',382),
  ('AtribOp -> AtribNum','AtribOp',1,'p_atribop_atribnum','yacc.py',387),
  ('AtribOp -> Op','AtribOp',1,'p_atribop_op','yacc.py',392),
  ('Decl -> ID ID','Decl',2,'p_decl','yacc.py',397),
  ('DeclArray -> ID ID DeclArraySize','DeclArray',3,'p_declarray','yacc.py',420),
  ('DeclArraySize -> DeclArraySize [ NUM ]','DeclArraySize',4,'p_declarraysize_rec','yacc.py',444),
  ('DeclArraySize -> [ NUM ]','DeclArraySize',3,'p_declarraysize_empty','yacc.py',450),
  ('AtribArray -> ID ArraySize LARROW AtribOp','AtribArray',4,'p_atribarray_Leftatribop','yacc.py',455),
  ('AtribArray -> AtribOp RARROW ID ArraySize','AtribArray',4,'p_atribarray_Rightatribop','yacc.py',490),
  ('ArraySize -> ArraySize [ AtribOp ]','ArraySize',4,'p_arraysize_rec','yacc.py',518),
  ('ArraySize -> [ AtribOp ]','ArraySize',3,'p_arraysize_empty','yacc.py',523),
  ('DeclAtrib -> ID ID LARROW AtribOp','DeclAtrib',4,'p_declatrib_left','yacc.py',528),
  ('DeclAtrib -> AtribOp RARROW ID ID','DeclAtrib',4,'p_declatrib_right','yacc.py',549),
  ('AtribNum -> ID LARROW AtribOp','AtribNum',3,'p_atribnum_left','yacc.py',570),
  ('AtribNum -> AtribOp RARROW ID','AtribNum',3,'p_atribnum_right','yacc.py',575),
  ('AtribNum -> AtribArray','AtribNum',1,'p_atribnum_array','yacc.py',581),
  ('Atrib -> ID LARROW AtribOp','Atrib',3,'p_atrib_left','yacc.py',586),
  ('Atrib -> AtribOp RARROW ID','Atrib',3,'p_atrib_right','yacc.py',591),
  ('Atrib -> ID SWAP ID','Atrib',3,'p_atrib_equiv','yacc.py',596),
  ('Atrib -> AtribArray','Atrib',1,'p_atrib_array','yacc.py',619),
  ('Op -> OpBin','Op',1,'p_op_opbin','yacc.py',629),
  ('OpUno -> NEG Base','OpUno',2,'p_opuno_neg','yacc.py',634),
  ('OpUno -> AccessArray','OpUno',1,'p_opuno_accessarray','yacc.py',639),
  ('OpUno -> SUB Base','OpUno',2,'p_opuno_minus','yacc.py',644),
  ('OpUno -> Base ?','OpUno',2,'p_opuno_print','yacc.py',649),
  ('AccessArray -> ID ArraySize','AccessArray',2,'p_accessarray','yacc.py',655),
  ('OpBin -> OpBin OpLogico TermPlus','OpBin',3,'p_opbin_rec','yacc.py',670),
  ('OpBin -> TermPlus','OpBin',1,'p_opbin_base','yacc.py',675),
  ('TermPlus -> TermPlus OpPlus TermMult','TermPlus',3,'p_termplus_rec','yacc.py',680),
  ('TermPlus -> TermMult','TermPlus',1,'p_termplus_base','yacc.py',685),
  ('TermMult -> TermMult OpMult TermPow','TermMult',3,'p_termmult_rec','yacc.py',690),
  ('TermMult -> TermPow','TermMult',1,'p_termmult_base','yacc.py',695),
  ('TermPow -> TermPow OpPow Base','TermPow',3,'p_termpow_rec','yacc.py',700),
  ('TermPow -> Base','TermPow',1,'p_termpow_base','yacc.py',705),
  ('Base -> OpUno','Base',1,'p_base_opuno','yacc.py',710),
  ('Base -> ( AtribOp )','Base',3,'p_base_exp','yacc.py',715),
  ('Base -> ID','Base',1,'p_base_id','yacc.py',720),
  ('Base -> NUM','Base',1,'p_base_num','yacc.py',733),
  ('Base -> FunCall','Base',1,'p_base_funcall','yacc.py',738),
  ('Base -> �','Base',1,'p_base_read','yacc.py',748),
  ('FunCall -> ID ( FunArg )','FunCall',4,'p_funcall','yacc.py',753),
  ('FunArg -> FunRec','FunArg',1,'p_funarg_funrec','yacc.py',774),
  ('FunArg -> <empty>','FunArg',0,'p_funarg_empty','yacc.py',779),
  ('FunRec -> FunRec , AtribOp','FunRec',3,'p_funrec_rec','yacc.py',784),
  ('FunRec -> AtribOp','FunRec',1,'p_funrec_base','yacc.py',790),
  ('OpLogico -> AND','OpLogico',1,'p_oplogico_and','yacc.py',795),
  ('OpLogico -> OR','OpLogico',1,'p_oplogico_or','yacc.py',800),
  ('OpLogico -> LESSER','OpLogico',1,'p_oplogico_lesser','yacc.py',805),
  ('OpLogico -> GREATER','OpLogico',1,'p_oplogico_greater','yacc.py',810),
  ('OpLogico -> LEQ','OpLogico',1,'p_oplogico_leq','yacc.py',815),
  ('OpLogico -> GEQ','OpLogico',1,'p_oplogico_geq','yacc.py',820),
  ('OpLogico -> EQUAL','OpLogico',1,'p_oplogico_equal','yacc.py',825),
  ('OpPlus -> ADD','OpPlus',1,'p_opplus_add','yacc.py',830),
  ('OpPlus -> SUB','OpPlus',1,'p_opplus_sub','yacc.py',835),
  ('OpMult -> MUL','OpMult',1,'p_opmult_mul','yacc.py',840),
  ('OpMult -> DIV','OpMult',1,'p_opmult_div','yacc.py',845),
  ('OpPow -> POW','OpPow',1,'p_oppow','yacc.py',850),
]
